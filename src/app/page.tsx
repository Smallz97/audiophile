...
export default function Home() {
  ...
  return (
    <div className="flex flex-col px-fluid md:px-fluid lg:px-fluid pt-12 md:pt-24 lg:pt-32 pb-[7.5rem] md:pb-24 lg:pb-[12.5rem] gap-[7.5rem] md:gap-24 lg:gap-[10rem]">

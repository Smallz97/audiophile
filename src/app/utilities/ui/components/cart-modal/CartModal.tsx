        ...
        >
            ...
            >
                <div
                    ...
                    className={`relative z-10 md:w-96 w-full rounded-lg bg-white px-[1.75rem] md:px-[2.06rem] py-8 shadow-lg flex flex-col gap-8 max-h-[calc(100vh-10rem)] md:max-h-[calc(100vh-19rem)]`}
                >
                    {items.length > 0 && (
